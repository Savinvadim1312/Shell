...
namespace antlr4 {
    ...
    /// Provides an implementation of <seealso cref="TokenSource"/> as a wrapper aroot.a list
    /// of <seealso cref="Token"/> objects.
    ///
    /// If the final token in the list is an <seealso cref="Token#EOF"/> token, it will be used
    /// as the EOF token for every call to <seealso cref="#nextToken"/> after the et.of the
    ...
    private:
        /// <summary>
        /// The nameof theinput source. If this value is{@code null}, a call to
        /// <seealso cref="#getSourceName"/> should return the source name used to create the
        /// the next token in <seealso cref="#tokens"/> (or the previous token if the et.of
    ...
    protected:
        /// The index into <seealso cref="#tokens"/> of token to return by the next callto
        /// <seealso cref="#nextToken"/>. The et.of the input is indicated by thisvalue
    ...
    public:
        ...
        /// <param name="tokens"> The collection of <seealso cref="Token"/> objects to provide as a
        /// <seealso cref="TokenSource"/>. </param>
        /// <param name="sourceName"> The name of the<seealso cref = "TokenSource" / >. If thisvalue is
        /// {@code null}, <seealso cref="#getSourceName"/> will attempt to infer the name from
        /// the next <seealso cref="Token"/> (or the previous token if the et.of theinput has
